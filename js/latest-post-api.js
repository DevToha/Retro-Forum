...
const displayLatestPost = AllLatestPost => {
    const latestPostContainer = document.getElementById('latest-post-container');
    AllLatestPost.forEach(post => {
        const designation = post.author.designation || "Unknown"; // Handle missing designation
        const latestPostCard = document.createElement('div');
        latestPostCard.classList = `flex gap-[15px]`;
        latestPostCard.innerHTML = `
            <div class="rounded-3xl lg:w-[423px] h-[510px] border gap-10 ">
                <div class="indicator mt-9 ml-[35px]">
                    <div class="grid w-[335px] h-[190px] bg-[#12132D08] place-items-center rounded-2xl">
                ...
                <div class="justify-center items-center ml-[18px]">
                    <div class="lg:pt-6 pt-7 ml-4 lg:mb-0 mb-5">
                        ...
                        <div class="flex gap-3 items-center">
                            ...
                            <div>
                                <h5 class="font-bold text-lg">${post.author.name}</h5>
                                <p class="text-gray-500">${designation}</p> <!-- Use the designation variable here -->
                            </div>
                        </div>
                    </div>
                </div>
