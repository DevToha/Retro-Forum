...
const displayPost = AllPost => {
    ...
    AllPost.forEach(post => {
        ...
        postCard.innerHTML = ` <div class="indicator mt-9">
        <span class="indicator-item mt-1 mr-2 badge bg-[#10B981]"></span>
        <div class="grid w-[75px] h-[70px] bg-base-300 place-items-center rounded-xl"><img class ="rounded-xl" src="${post.image}" alt=""></div>
    </div>
    ...
    <div class="mt-[15px]">
        <div class=" lg:pt-6 pt-7 ml-4 lg:mb-0 mb-5">
            ...
            <div>
                <h2 class="card-title font-extrabold text-[20px] mb-2">${post.title}
                </h2>
